...
from utils.ip_pools import (
    MyIpPools,
    ip_proxy_pool,
    sesame_ip_pool,
    tri_ip_pool, )
from utils.internet_utils import get_base_headers
...
class MyRequests(object):
    ...
    def _download_file(cls,
        ...
        with requests.get(url=url, headers=headers, params=params, cookies=cookies, proxies=tmp_proxies,
