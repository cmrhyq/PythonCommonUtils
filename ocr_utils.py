...
from utils.img_utils import read_img_use_base64
from utils.common_utils import json_2_dict
from utils.spider.requests import Requests
...
def baidu_ocr_captcha(app_id, api_key, secret_key, img_path, orc_type=3) -> dict:
    ...
    basic_general_options = {
        ...
        # 识别语言类型， 默认为CHN_ENG。 选值包括：-CHN_ENG： 中英文混合；-ENG：
        # 英文；-POR：葡萄牙语；-FRE：法语；-GER：德语；-ITA：意大利语；-SPA：西班牙语；-RUS：俄语；-JAP：日语
